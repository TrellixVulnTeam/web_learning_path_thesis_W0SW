...
// ตัวอย่างที่ใช้แสดงแบบฟอร์ม และเติม Text แบบ Auto
// ของ google ที่ api เพื่อช่วยให้ใช้กรอกข้อมูล
...
function initialize() {
    // สร้างวัตถุและเติมข้อความ Auto โดยมีขอบเขตในการค้นหา
    // ไปยังแต่ละประเภทของแต่ละ location
    autocomplete = new google.maps.places.Autocomplete(
        /** @type {HTMLInputElement} */
        (document.getElementById('autocomplete')), { types: ['geocode'] });
    // เมื่อผู้ใช้เลือกที่อยู่จาก dropdown,
    // กรอกฟิลด์ที่อยู่ในแบบฟอร์ม
