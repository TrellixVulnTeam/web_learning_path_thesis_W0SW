function myFunction() {
    document.getElementById("demo").innerHTML = "<h>Project 1</h>";
    ...
    document.getElementById("demo6").innerHTML = "<div class='topnav-right'><a  class='button1' style='vertical-align:middle' ><span>Start</span></a></div>"
}
